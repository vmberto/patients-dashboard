...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.css":
/*!*********************************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.css ***!
  \*********************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.html":
/*!**********************************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.html ***!
  \**********************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.ts":
/*!********************************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.ts ***!
  \********************************************************************************************************/
...
var PatientDataComponent = /** @class */ (function () {
    function PatientDataComponent() {
        this.editPatientData = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    ...
    PatientDataComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./patient-data.component.html */ "./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.html"),
            styles: [__webpack_require__(/*! ./patient-data.component.css */ "./src/app/components/pages/patients/patients-show-wrapper/patient-data/patient-data.component.css")]
        }),
        __metadata("design:paramtypes", [])
...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patient-sessions/patient-sessions.component.html":
/*!******************************************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patient-sessions/patient-sessions.component.html ***!
  \******************************************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patient-sessions/patient-sessions.component.ts":
/*!****************************************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patient-sessions/patient-sessions.component.ts ***!
  \****************************************************************************************************************/
...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patients-show.component.css":
/*!*********************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patients-show.component.css ***!
  \*********************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patients-show.component.html":
/*!**********************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patients-show.component.html ***!
  \**********************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/pages/patients/patients-show-wrapper/patients-show.component.ts":
/*!********************************************************************************************!*\
  !*** ./src/app/components/pages/patients/patients-show-wrapper/patients-show.component.ts ***!
  \********************************************************************************************/
...
var PatientsShowComponent = /** @class */ (function () {
    function PatientsShowComponent(activatedRoute, patientsService, shareData) {
        this.activatedRoute = activatedRoute;
        this.patientsService = patientsService;
    ...
    PatientsShowComponent.prototype.loadData = function (sessions_limit) {
        ...
        this.activatedRoute.params.subscribe(function (res) {
            _this.patientsService.get({ id: res.id, query: { sessions_limit: sessions_limit } }).subscribe(function (res) {
                _this.shareData.activateLoadingScreen(false);
                _this.patientData = res;
                _this.patientSessions = res.Sessions;
                Object(src_app_app_utils__WEBPACK_IMPORTED_MODULE_4__["sortByKey"])(_this.patientSessions, 'created_at');
            }, function () {
                _this.shareData.activateLoadingScreen(false);
            });
        });
    ...
    PatientsShowComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'app-show',
            template: __webpack_require__(/*! ./patients-show.component.html */ "./src/app/components/pages/patients/patients-show-wrapper/patients-show.component.html"),
...
var AnamnesisService = /** @class */ (function (_super) {
    ...
    AnamnesisService.prototype.downloadAnamnesis = function (id) {
        ...
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].API_URL + "/api/" + this.entity + "/download/" + id, { headers: headers, responseType: 'blob' }).toPromise();
    };
